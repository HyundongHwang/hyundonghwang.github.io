...
가장 먼저 전문 댄서님 즉 이 클래스의 선생님이 아주 정확하게 각 댄스 컨텐츠 별로 GT 영상을 만들어 주셔야 합니다.
우리같은 일반인은 감히 상상도 할 수 없지만, 우리 선생님들은 며칠전에만 알려드리면 혼자서 4곡의 안무를 외워오실수 있습니다.
한곡당 30분 정도 보면서 연습해 보면 구간이 30초 정도로 짧은 경우는 외우실수 있다고 합니다.
...
이렇게 해서 촬영 스튜디오의 오디오 잡음을 원천 봉쇄합니다.
그 다음은 평가기준점을 만들기 위해 오디오 분석을 합니다.
이는 물론 AI에 의존하여 자동으로도 할 수 있지만 더 고품질을 위해 수작업을 합니다.
영상에 매핑된 오디오트랙을 듣고 비트분석을 합니다.
