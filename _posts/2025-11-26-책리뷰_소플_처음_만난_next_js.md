...
comments: true
tags: [책리뷰, Next.js, React, JavaScript, TypeScript, 웹개발, 프론트엔드, 풀스택, 앱라우터, 라우팅, SSR, SSG, 서버컴포넌트, 클라이언트컴포넌트, 메타데이터, OpenGraph, API, 라우트핸들러, 미들웨어, 서버액션, SWR, 캐시, 성능최적화, npm, 패키지관리, 웹프레임워크, 모던웹, JAMstack]
---
